...
class Post extends Model {
    ...
    public function fetch() {
        if ( empty($this->attributes['id']) )
            throw new BadMethodCallException(__("Need a post id to fetch a post"));
...
class PostCollection extends Collection {
    public static $model = 'hitfigure\models\Post';
...
class AttachmentCollection extends PostCollection {
    public static $model = 'hitfigure\models\Attachment';
...
class User extends Model {
    ...
    public static $collection = 'hitfigure\models\UserCollection';
...
class UserCollection extends Collection {
    public static $model = 'hitfigure\models\User';
...
class SiteCollection extends Collection {
    public static $model = 'hitfigure\models\Site';
